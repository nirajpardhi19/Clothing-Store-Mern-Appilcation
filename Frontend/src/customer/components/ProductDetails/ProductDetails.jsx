        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          >
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font font-semibold text-gray-900">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className=" flex space-x-5 items-center text-lg lg-text-xl text-gray-900 mt-6">
                ...
                <p className="opacity-50 line-through">₹{products.product?.price}11</p>
                <p className="text-green-600 font font-semibold">{products.product?.discountPersent}% off</p>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="ml-3 text-sm font medium text-indigo-600 hover:text-indigo-500">3303 Reviews</p>
                </div>
